...
public class Parameter {
    ...
    public static PotentialMap potentialMap = new PotentialMap(scale, CELL_INTERVAL, MAXPOTENTIAL);
    ...
    public static final CStatic wallLeftLine = new CStatic(100, 100, 100, 910);
