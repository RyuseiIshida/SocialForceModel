...
//    public final ArrayList<Rect> arrayRect = new ArrayList<>(Arrays.asList(wakumigi,wakuhidari,wakuue,wakushita,wakuuehidari,wakuuemigi,aida1,aida2,aida3,aida4));
    ...
    public final CStatic wakumigi = new CStatic(1500,80,10,700);
    public final CStatic wakuhidari = new CStatic(100,80,10,700);
    public final CStatic wakuue = new CStatic(100,900,1400,10);
    public final CStatic wakuuehidari = new CStatic(100,850,10,50);
    public final CStatic wakuuemigi = new CStatic(1500,850,10,60);
    public final CStatic wakushita = new CStatic(100,80,1400,10);
    public final CStatic aida1 = new CStatic(100,700,300,10);
    public final CStatic aida2 = new CStatic(500,700,600,10);
    public final CStatic aida3 = new CStatic(1200,700,300,10);
    public final CStatic aida4 = new CStatic(790,80,10,620);
